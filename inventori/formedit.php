...
$sql = "SELECT * FROM inventori WHERE id_barang='$id_barang'";
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <input type="hidden" name="id_barang" value="<?php echo $no['id_barang']?>">
                    ...
                    <div class="form-floating mt-3">
                        ...
                        <label for="floatingInput">Masukkan Unit</label>
                        <input type="text" class="form-control" name="unit" value="<?php echo $no['unit']?>">
                    </div>
