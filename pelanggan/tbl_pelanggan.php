...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <h2 class="ml-3 mt-2">Data Pelanggan</h2>
    <a href="datapelanggan.html" class="btn btn-success mt-3 mb-1">Tambah Data Baru</a>
...
while($no =mysqli_fetch_array($query)){
    ...
    echo "<td>";
    echo "<a href='formedit.php?id_user=".$no['id_user']."'class='btn btn-warning'>Edit</a> | ";
    echo "<a href='hapus.php?id_user=".$no['id_user']."'class='btn btn-danger'>Hapus</a>";
    echo "</td>";
    echo "</tr>";
}
?>
