...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <h2 class="ml-3 mt-2">Data Pegawai</h2>
    <a href="datapegawai.html" class="btn btn-success mt-3 mb-1">Tambah Data Baru</a>
...
while($no =mysqli_fetch_array($query)){
    ...
    echo "<td>".$no['id_pegawai']."</td>";
    echo "<td>".$no['nama_pegawai']."</td>";
    echo "<td>".$no['email']."</td>";
    echo "<td>".$no['alamat']."</td>";
    echo "<td>".$no['no_telp']."</td>";

    echo "<td>";
    echo "<a href='formedit.php?id_pegawai=".$no['id_pegawai']."'class='btn btn-warning'>Edit</a> | ";
    echo "<a href='hapus.php?id_pegawai=".$no['id_pegawai']."'class='btn btn-danger'>Hapus</a>";
    echo "</td>";
    echo "</tr>";
}
?>
