...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <h2 class="ml-3 mt-2">Data Inventori</h2>
    <a href="datapeminjaman.html" class="btn btn-success mt-3 mb-1">Tambah Data Baru</a>
...
while($no =mysqli_fetch_array($query)){
    ...
    echo "<td>".$no['id_peminjaman']."</td>";
    echo "<td>".$no['id_barang']."</td>";
    echo "<td>".$no['nama_barang']."</td>";
    echo "<td>".$no['id_user']."</td>";
    echo "<td>".$no['nama_user']."</td>";
    echo "<td>".$no['qty']."</td>";

    echo "<td>";
    echo "<a href='formedit.php?id_peminjaman=".$no['id_peminjaman']."'class='btn btn-warning'>Edit</a> | ";
    echo "<a href='hapus.php?id_peminjaman=".$no['id_peminjaman']."'class='btn btn-danger'>Hapus</a>";
    echo "</td>";
    echo "</tr>";
}
?>
