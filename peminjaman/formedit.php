      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../barang/tbl_barang.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Barang</p>
                </a>
              </li>
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <input type="hidden" name="id_peminjaman" value="<?php echo $no['id_peminjaman']?>">

                    <h2>Edit Data Peminjaman</h2>
                    <div class="form-floating mt-3">
                        
                        <label for="floatingInput">Masukkan ID Peminjaman</label>
                        <input type="text" class="form-control" name="id_peminjaman" value="<?php echo $no['id_peminjaman']?>">
                    </div>

                    <div class="form-floating mt-3">
                        
                        <label for="floatingInput">Masukkan ID Barang</label>
                        <input type="text" class="form-control" name="id_barang" value="<?php echo $no['id_barang']?>">
                    </div>

                    <div class="form-floating mt-3">
                        
                        <label for="floatingInput">Masukkan Nama Barang</label>
                        <input type="text" class="form-control" name="nama_barang" value="<?php echo $no['nama_barang']?>">
                    </div>

                    <div class="form-floating mt-3">
                        
                        <label for="floatingInput">Masukkan ID User</label>
                        <input type="text" class="form-control" name="id_user" value="<?php echo $no['id_user']?>">
                    </div>

                    <div class="form-floating mt-3">
                        
                        <label for="floatingInput">Masukkan Nama User</label>
                        <input type="text" class="form-control" name="nama_user" value="<?php echo $no['nama_user']?>">
                    </div>

                    <div class="form-floating mt-3">
                        
                        <label for="floatingInput">Masukkan Jumlah</label>
                        <input type="number" class="form-control" name="qty" value="<?php echo $no['qty']?>">
                    </div>
                    <input type="submit" name="simpan" value="simpan" class="btn btn-success float-right mt-3">
                </form>
            </div>
        </div>
    </div>
